...
return function (RouteCollection $router) {
    ...
    $router->get('/{type:slug}/{element:slug}.html', [PublicContentController::class, 'element'])->setName('content.rootElement')->setPriority(-100020);
    $router->get('/{type:slug}/{sectionPath:path}', [PublicContentController::class, 'section'])->setName('content.section')->setPriority(-100030);
};
